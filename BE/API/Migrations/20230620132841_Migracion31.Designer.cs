...
namespace API.Migrations
{
    ...
    [Migration("20230620132841_Migracion31")]
    partial class Migracion31
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.DetalleCobranza", b =>
                {
                    b.HasOne("API.Models.Cobranza", "Cobranza")
                        .WithMany("DetalleCobranza")
                        .HasForeignKey("CobranzaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Models.Factura", "Factura")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Models.Cobranza", b =>
                {
                    b.Navigation("DetalleCobranza");
                });

            modelBuilder.Entity("API.Models.Presupuesto", b =>
                {
                    b.Navigation("DetallePresupuesto");
                });
